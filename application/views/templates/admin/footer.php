...
<script>
    $('.addCompany').click(function(){
        ...
        document.getElementById('comp_contactno').value = '';
    });
    $('.editCompany').click(function(){
        var data=$(this).data('id');
        var id=data.split('_');
        document.getElementById('comp_id').value = id[0];
        document.getElementById('comp_name').value = id[1];
        document.getElementById('comp_address').value = id[2];
        document.getElementById('comp_email').value = id[3];
        document.getElementById('comp_contactno').value = id[4];
    });
</script>
